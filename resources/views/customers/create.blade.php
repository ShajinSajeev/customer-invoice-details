                ...
                <div class="flex py-2 justify-between">
                    ...
                    <div class="grid w-full grid-cols-1 mt-10 gap-7">
                        <div class="flex gap-2 flex-col">
                            ...
                            <input type="text" name="name" id="name" class="h-12 rounded border border-zinc-500 w-full" required>
                        </div>
                        <div class="flex gap-2 flex-col">
                            <label class="w-48"  for="phone">Customer Phone</label>
                            <input type="text" name="phone" id="phone" class="h-12 rounded border border-zinc-500 w-full">
                        </div>
                        <div class="flex gap-2 flex-col">
                            <label class="w-48" for="email">Customer Email</label>
                            <input type="email" name="email" id="email" class="h-12 rounded border border-zinc-500 w-full">
                        </div>
                        <div class="flex gap-2 flex-col">
