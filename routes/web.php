...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('data')->group(function () {
        Route::get('list/{type}', [ModularController::class, 'index'])->name('data.list');
        Route::get('new/{type}', [ModularController::class, 'create'])->name('data.new');
        Route::post('store/{type}', [ModularController::class, 'store'])->name('data.store');
        Route::get('edit/{type}/{id}', [ModularController::class, 'edit'])->name('data.edit');
        Route::post('update/{type}', [ModularController::class, 'update'])->name('data.update');
        Route::get('destroy/{type}/{id}', [ModularController::class, 'destroy'])->name('data.destroy');
    });
